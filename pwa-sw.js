...
const OFFLINE_PAGE = 'http://localhost/midterm/';
const NOT_FOUND_PAGE = 'http://localhost/midterm/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('http://localhost/midterm//wp-admin/');
//    },
];
